...
<!-- CODIGO PARA APRESENTACAO -->
					<input type="text" id="nome" name="nome" class="form-control" value="<?php if(isset($_POST['nome'])){echo $_POST['nome'];}else{echo "Diogo Santos";}?>">
<!-- CODIGO ORIGINAL 
...
<!-- CODIGO PARA APRESENTACAO -->
					<input type="text" id="fiscalNumber" name="fiscalNumber" class="form-control" value="<?php if(isset($_POST['fiscalNumber'])){echo $_POST['fiscalNumber'];}else{echo "999999999";}?>">
<!-- CODIGO ORIGINAL 
...
<!-- CODIGO PARA APRESENTACAO -->
					<input type="tel" pattern="^\d{9}" title="xxxxxxxxx" id="phone" name="phone" class="form-control" value="<?php if(isset($_POST['phone'])){echo $_POST['phone'];}else{echo "999999999";}?>">
<!-- CODIGO ORIGINAL 					
...
<!-- CODIGO PARA APRESENTACAO -->
					<input type="email" name="email" id="email" class="form-control" value="<?php if(isset($_POST['email'])){echo $_POST['email'];}else{echo "dmos999@gmail.com";}?>">
<!-- CODIGO ORIGINAL -					
...
<!-- CODIGO PARA APRESENTACAO -->
						<input type="date" name="birthDate" id="birthDate" class="form-control" value="<?php if(isset($_POST['birthDate'])){echo $_POST['birthDate'];}else{echo "1995-02-02";}?>">
<!-- CODIGO ORIGINAL 							
		...
		<div class="container-fluid">
			<div class="col-lg-12">
				<div class="form-group">
					<label>Morada:</label>
<!-- CODIGO PARA APRESENTACAO -->
					<input type="text" name="address" id="address" class="form-control" value="<?php if(isset($_POST['address'])){echo $_POST['address'];}else{echo "Oiã";}?>">
<!-- CODIGO ORIGINAL 					
...
<!-- CODIGO PARA APRESENTACAO -->
					<input type="text" name="username" id="username" class="form-control" value="<?php if(isset($_POST['username'])){echo $_POST['username'];}else{echo "diogo";}?>">
<!-- CODIGO ORIGINAL 					
