...
<html>
  ...
  -->
    ...
    <style type="text/css">
      ...
      .purple{background-color: orange;}
  ...
  <body>
    ...
    <h1> Calendário </h1>
      ...
      <div id="semanas_dinamicas">
        <button id="anterior" class="btn"><</button>
        <div id="semanas"></div>
        <button id="seguinte" class="btn"> > </button>
      </div>
    ...
    <div class="modal fade " id="modal_aula" role="dialog">
       ...
       -->
        ...
        $(document).ready(function(){
          ...
          var hoj =  new Date();
          var hoj =  hoj.getDate() + "/" +(hoj.getMonth()+1) + "/" +hoj.getFullYear();
          ...
          var a = new Date().getFullYear();
              ...
              if(sessao_tipo == "aluno"){
                  ...
                  $(document).on('click','td',function(event){
                    event.stopImmediatePropagation();
                    if($(this).html() == "" && hoj <= $(this).data('data')){
